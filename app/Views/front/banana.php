...
<?= $this->section('title') ?>Banana Boat<?= $this->endSection() ?>
...
<div class="container my-4">
    <h2 class="text-center">Menu Banana Boat</h2>

    <!-- Baris pertama -->
    <div class="row d-flex justify-content-center text-center">
        <div class="col-md-4 my-2">
            <div class="card w-100 ">
                <img src="<?= base_url('img/produk/bbcoklat.png') ?>" class="card-img-top custom-card-img" alt="...">
                <div class="card-body">
        ...
        <div class="col-md-4 my-2">
            <div class="card w-100 ">
                <img src="<?= base_url('img/produk/bbtiramisu.png') ?>" class="card-img-top custom-card-img" alt="...">
                <div class="card-body">
        ...
        <div class="col-md-4 my-2">
            <div class="card w-100 ">
                <img src="<?= base_url('img/produk/bbmatcha.png') ?>" class="card-img-top custom-card-img" alt="...">
                <div class="card-body">
        ...
        <div class="col-md-4 my-2">
            <div class="card w-100 ">
                <img src="<?= base_url('img/produk/bbstrawberry.png') ?>" class="card-img-top custom-card-img" alt="...">
                <div class="card-body">
